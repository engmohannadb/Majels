...
<div class="main-content">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-light">
                            <strong>تفاصيل الوحدة</strong>
                        </div>
                        <div class="card-body">
                            <p><strong>الوصف:</strong> <?php echo nl2br(htmlspecialchars($unit['description'] ?? 'لا يوجد وصف.')); ?></p>
                            <p><strong>العنوان:</strong> <?php echo htmlspecialchars($unit['address'] ?? 'غير محدد'); ?></p>
                            <p><strong>تاريخ الإنشاء:</strong> <?php echo htmlspecialchars($unit['created_at'] ?? 'غير متوفر'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
        <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
            <div class="bg-overlay bg-overlay--blue"></div>
            <h3>
                <i class="zmdi zmdi-comment-text"></i>الرسائل الجديدة
            </h3>
        </div>
